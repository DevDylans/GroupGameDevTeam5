...
TexturedQuad::TexturedQuad(Microsoft::WRL::ComPtr<ID3D11Device>& device)
{
	TexturedVertex vertices[] =
	{
		{DirectX::XMFLOAT3(-0.5f, -0.5f, 1.0f), DirectX::XMFLOAT2(0.0f,0.0f)},
		{DirectX::XMFLOAT3(0.5f, -0.5f, 1.0f), DirectX::XMFLOAT2(1.0f,0.0f)},
